...
public class Manager {
    ...
    public void createStudent() {
        ...
        while (true) {
            ...
            if (!vd.checkIdExist(students, id)) {
                ...
                int semester = input.checkInputSemester();
                String course = displayCourseMenu();
                if (!vd.checkStudentExist(students, id, existingName, semester, course)) {
                ...
                name = input.checkInputName();
                System.out.print("Enter semester: ");
                int semester = input.checkInputSemester();
                String course = displayCourseMenu();
                if (vd.checkStudentExist(students, id, name, semester, course)) {
    ...
    public String displayCourseMenu() {
        Menu menu = new Menu("CHOOSE YOUR COURSE: ", new String[]{"Java", ".Net", "C/C++"});
    ...
    public void findAndSort() {
        ...
        String name = input.checkInputName();
        System.out.println("\nList of Students: ");
    ...
    public void updateOrDelete() {
        ...
        if (listStudentFindByName.isEmpty()) {
            ...
            if (vd.checkInputUD()) {
                System.out.print("Enter name student: ");
                String newName = input.checkInputName();
                System.out.print("Enter semester: ");
                int newSemester = input.checkInputSemester();
                String newCourse = displayCourseMenu();
                if (!vd.checkChangeInfomation(student, id, newName, newSemester, newCourse)) {
                    System.err.println("Nothing change.");
                }
                if (vd.checkStudentExist(students, id, newName, newSemester, newCourse)) {
    ...
    public Student getStudentByListFound(ArrayList<Student> listStudentFindByName) {
        ...
        int choice = input.checkInputIntLimit(1, listStudentFindByName.size());
